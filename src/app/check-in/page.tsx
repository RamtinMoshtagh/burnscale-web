...
export default function CheckInPage() {
  ...
  <div className="max-w-2xl mx-auto bg-white shadow-lg rounded-2xl p-8 space-y-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div>
        <label htmlFor="meaningfulness" className="block text-sm font-medium mb-1">
    ...
    <div>
        ...
        {stressOptions.map((opt) => (
          <div key={opt} className="flex items-center bg-gray-100 rounded-full px-3 py-1 border text-sm">
            <button
              ...
              aria-pressed={stressTriggers.includes(opt)}
              className={`mr-2 ${
            ...
            <button
              type="button"
              aria-label={`Delete stress trigger ${opt}`}
              onClick={() =>
                deleteOption(opt, stressOptions, setStressOptions, stressTriggers, setStressTriggers)
              }
      ...
      <div className="flex gap-2">
        <label htmlFor="customStress" className="sr-only">Add custom trigger</label>
        <input
          id="customStress"
          name="customStress"
          type="text"
    ...
    <div>
        ...
        {recoveryOptions.map((opt) => (
          <div key={opt} className="flex items-center bg-gray-100 rounded-full px-3 py-1 border text-sm">
            <button
              ...
              aria-pressed={recoveryActivities.includes(opt)}
              className={`mr-2 ${
            ...
            <button
              type="button"
              aria-label={`Delete recovery activity ${opt}`}
              onClick={() =>
                deleteOption(opt, recoveryOptions, setRecoveryOptions, recoveryActivities, setRecoveryActivities)
              }
              className="text-gray-400 hover:text-red-500 text-xs"
            >
              ×
      ...
      <div className="flex gap-2">
        <label htmlFor="customRecovery" className="sr-only">Add custom activity</label>
        <input
          id="customRecovery"
          name="customRecovery"
          type="text"
